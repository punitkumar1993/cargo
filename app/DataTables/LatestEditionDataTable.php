...
class LatestEditionDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('active', function ($query) {
                ...
                $id = $query->id;
                return view('admin.edition._checked', compact('checked', 'id'));
            })
            ->addColumn('action', function ($query) {
                return view('layouts.partials._action', [
                    'table' => 'ad-table',
                    'model' => $query,
                    'edit_url' => route('latest-edition.edit', $query->id)
                ]);
            })
            ->rawColumns(['checkbox']);
    }
     ...
     */
    public function query(LatestEdition $model)
    {
