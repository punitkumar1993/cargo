...
class RolesDataTable extends DataTable
{
        ...
        return datatables()
            ...
            ->addColumn('action', function ($query) {
                return view('layouts.partials._action', [
                    'table' => 'role-table',
                    'model' => $query,
                    'del_url' => route('roles.destroy', $query->id),
    ...
    public function query(Role $model)
    {
        if (Auth::User()->hasRole('superadmin')) {
            ...
            return $model->whereNotIn('name', ['superadmin'])->latest()->newQuery();
        } else {
            return $model->whereNotIn('name', ['superadmin', 'admin'])->latest()->newQuery();
        }
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('name')->title('Role')
                ->footer('<button type="button" name="bulk_delete" id="bulk_delete" class="btn btn btn-xs btn-danger" data-url="'.route('roles.massdestroy').'">Delete</button>'),
