...
class AdvertisementController extends Controller
{
    ...
    {
        $this->path = storage_path('app/public/advertisement');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.advertisement.edit', compact('ad','image','width','height'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('advertisement.index')->withSuccess('Updating successfully!');
    }
