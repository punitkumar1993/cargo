$(function() {
                ...
                newsletter = {
                    ...
                    error: function(xhr, statusText, err) {
                        ...
                        if(xhr.status == 422){
                            ...
                            error = 'Failed, network error. Please try again!';
                        }
                        $.toast({
                            text: error,
                            position: 'bottom-right',
            ...
            if ($this.find(".email").val().trim().length < 1) {
                ...
                $.ajax({
                    ...
                    error: function(xhr, statusText, err) {
                        ...
                        newsletter.error(xhr, statusText, err);
                    },
                    beforeSend: function() {
                        newsletter.start();
                    },
    ...
    var sendMagazineForm = function() {
        $("#magazine-form").submit(function() {
            var $this = $(this);
            var url = $("#magazin_ajax_url").val();
    ...
    jQuery(document).ready(function() {
      equalheight('.equalHeight div.inner');
    });
