...
@head(['linkIndex'=>'Newsletter','currentLinkAdd'=>'Edit','url'=> route('newsletter.index')])
@slot('title')
{{ __('Edit Newsletter') }}
@endslot
@endhead
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-default">
            <form action="{{route('newsletter.update', [$ad->id])}}" method="POST" role="form" enctype="multipart/form-data">
            @method('PUT')
            @csrf
                <div class="card-body">
...
@include('admin.newsletters.style')
@stop

@section('adminlte_js')
<script src="{{ asset('vendor/select2/js/select2.min.js') }}"></script>
@include('admin.newsletters.script')
@stop
