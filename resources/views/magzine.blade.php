...
<link rel="stylesheet" type="text/css" href="{{asset('/3dcargo/css/flipbook.style.css')}}">

<link rel="stylesheet" type="text/css" href="{{asset('/3dcargo/css/font-awesome.css')}}">



<script src="{{asset('/3dcargo/js/flipbook.min.js')}}"></script>
